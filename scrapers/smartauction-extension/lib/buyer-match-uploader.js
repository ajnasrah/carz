...
(function () {
  ...
  function segment(make, model) {
    ...
    // Vans first: the truck list below matches on bare '1500'/'2500'/'3500' to
    // catch "Silverado 1500", and those also appear in "RAM PROMASTER 2500" and
    // "CHEVROLET EXPRESS G3500". Nothing in the van list can be a pickup, so this
    // order is the safe one. MUST match sa_segment() and services/buyerMatch.js.
