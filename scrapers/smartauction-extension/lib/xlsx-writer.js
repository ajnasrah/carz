// Minimal XLSX writer for Chrome Extensions (no dependencies).
// Builds a valid .xlsx from rows of data using browser-native APIs:
//   rows -> SpreadsheetML XML -> ZIP (STORE, no compression) -> Blob
//
// Counterpart to lib/xlsx-parser.js (which only reads). Supports the subset we
// need for report exports: one sheet, inline strings, numbers, a small fixed
// style palette, frozen header row, autofilter, and column widths.
//
// Usage:
